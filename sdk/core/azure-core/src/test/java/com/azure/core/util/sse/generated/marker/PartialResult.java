...
/**
 * Fixture model for the {@code partialResult} SSE event (scenario 3, marker-interface shape).
 */
public final class PartialResult implements JsonSerializable<PartialResult>, RetrievalEvents {
    private String text;
