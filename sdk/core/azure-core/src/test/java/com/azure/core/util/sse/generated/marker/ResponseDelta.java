...
/**
 * Fixture model for the {@code responseDelta} SSE event (scenario 2, marker-interface shape).
 */
public final class ResponseDelta implements JsonSerializable<ResponseDelta>, ResponseEvents {
