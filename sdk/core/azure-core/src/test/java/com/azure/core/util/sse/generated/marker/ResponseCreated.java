...
/**
 * Fixture model for the {@code responseCreated} SSE event (scenario 2, marker-interface shape). The model keeps its
 * own {@code JsonSerializable} and additively {@code implements} the {@link ResponseEvents} marker.
 */
public final class ResponseCreated implements JsonSerializable<ResponseCreated>, ResponseEvents {
    private String id;
