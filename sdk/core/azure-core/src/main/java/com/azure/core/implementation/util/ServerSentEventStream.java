...
public final class ServerSentEventStream {
    ...
    /**
     * Decodes an SSE response and cancels its body publisher when consumption ends early.
     */
    ...
    /**
     * Processes an SSE response, closing the body subscription on completion, failure, or interruption.
     */
