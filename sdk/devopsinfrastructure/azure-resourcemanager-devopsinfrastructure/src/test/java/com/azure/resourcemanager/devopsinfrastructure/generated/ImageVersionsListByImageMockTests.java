...
public final class ImageVersionsListByImageMockTests {
    ...
    public void testListByImage() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"version\":\"wiipfpub\"},\"id\":\"bwwift\",\"name\":\"hqkvpuvksgplsak\",\"type\":\"ynfs\"}]}";
        ...
        PagedIterable<ImageVersion> response
            = manager.imageVersions().listByImage("uu", "jfqka", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("wiipfpub", response.iterator().next().properties().version());
    }
}
