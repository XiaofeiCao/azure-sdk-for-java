...
public final class StatelessAgentProfileTests {
    ...
    public void testDeserialize() throws Exception {
        StatelessAgentProfile model = BinaryData.fromString(
            "{\"kind\":\"Stateless\",\"resourcePredictions\":\"datauthnnprnxipeilpj\",\"resourcePredictionsProfile\":{\"kind\":\"ResourcePredictionsProfile\"}}")
            .toObject(StatelessAgentProfile.class);
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        StatelessAgentProfile model = new StatelessAgentProfile().withResourcePredictions("datauthnnprnxipeilpj")
