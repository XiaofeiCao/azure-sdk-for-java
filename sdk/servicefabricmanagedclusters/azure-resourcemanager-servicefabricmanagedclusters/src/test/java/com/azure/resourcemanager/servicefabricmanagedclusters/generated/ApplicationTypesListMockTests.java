...
public final class ApplicationTypesListMockTests {
    ...
    public void testList() throws Exception {
        String responseStr
            = "{\"value\":[{\"properties\":{\"provisioningState\":\"ohu\"},\"tags\":{\"kozzwculkb\":\"t\",\"jwltlwtjjgu\":\"wpfaj\"},\"location\":\"alhsnvkc\",\"id\":\"xzrpo\",\"name\":\"imlnwiaaomylw\",\"type\":\"azul\"}]}";
        ...
        PagedIterable<ApplicationTypeResource> response
            = manager.applicationTypes().list("lftidgfcwqmpim", "qxzhem", com.azure.core.util.Context.NONE);

        Assertions.assertEquals("t", response.iterator().next().tags().get("kozzwculkb"));
        Assertions.assertEquals("alhsnvkc", response.iterator().next().location());
    }
}
