...
public final class ManagedAzResiliencyStatusOperationsGetWiMockTests {
    ...
    public void testGetWithResponse() throws Exception {
        String responseStr
            = "{\"baseResourceStatus\":[{\"resourceName\":\"bgopxlhslnel\",\"resourceType\":\"eixynllxecwcroj\",\"isZoneResilient\":true,\"details\":\"hcawjutifdwfmv\"}],\"isClusterZoneResilient\":false}";
        ...
        ManagedAzResiliencyStatus response = manager.managedAzResiliencyStatusOperations()
            .getWithResponse("mifrygznmma", "ri", com.azure.core.util.Context.NONE)
            .getValue();
