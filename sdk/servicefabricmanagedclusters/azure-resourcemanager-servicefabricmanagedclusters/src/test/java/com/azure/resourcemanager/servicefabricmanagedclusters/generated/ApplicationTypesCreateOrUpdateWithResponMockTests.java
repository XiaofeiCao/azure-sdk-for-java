...
public final class ApplicationTypesCreateOrUpdateWithResponMockTests {
    ...
    public void testCreateOrUpdateWithResponse() throws Exception {
        String responseStr
            = "{\"properties\":{\"provisioningState\":\"gg\"},\"tags\":{\"jcivmmg\":\"ijr\",\"fiwrxgkn\":\"f\",\"oxgsgbpfgzdjtx\":\"uvyinzqodfvpgs\",\"qvlgafcqusrdvetn\":\"zflbqvg\"},\"location\":\"dtutnwldu\",\"id\":\"vuzhyr\",\"name\":\"ewipm\",\"type\":\"ekdxuku\"}";
        ...
        ApplicationTypeResource response = manager.applicationTypes()
            .define("ousnfepgfewe")
            .withExistingManagedCluster("sethwwn", "jhlfzswpchwahf")
            .withRegion("fpxtg")
            .withTags(mapOf("cjzhqi", "cxfhbcporxv"))
            .create();

        Assertions.assertEquals("ijr", response.tags().get("jcivmmg"));
