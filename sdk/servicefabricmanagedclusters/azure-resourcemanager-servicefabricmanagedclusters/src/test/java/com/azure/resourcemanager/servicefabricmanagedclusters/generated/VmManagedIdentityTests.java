...
public final class VmManagedIdentityTests {
    ...
    public void testDeserialize() throws Exception {
        VmManagedIdentity model = BinaryData
            .fromString("{\"userAssignedIdentities\":[\"y\",\"ngwfqatm\",\"dhtmdvypgikd\",\"szywkbirryu\"]}")
            .toObject(VmManagedIdentity.class);
        Assertions.assertEquals("y", model.userAssignedIdentities().get(0));
    }

    @org.junit.jupiter.api.Test
    public void testSerialize() throws Exception {
        VmManagedIdentity model = new VmManagedIdentity()
            .withUserAssignedIdentities(Arrays.asList("y", "ngwfqatm", "dhtmdvypgikd", "szywkbirryu"));
