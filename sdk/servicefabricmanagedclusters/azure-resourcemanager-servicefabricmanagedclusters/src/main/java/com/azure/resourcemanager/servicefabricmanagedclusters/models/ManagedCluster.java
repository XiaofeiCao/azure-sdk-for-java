...
public interface ManagedCluster {
     ...
     */
    FaultSimulation startFaultSimulation(FaultSimulationContent parameters);
     ...
     * @return fault simulation object with status.
     */
    FaultSimulation startFaultSimulation(FaultSimulationContent parameters, Context context);
