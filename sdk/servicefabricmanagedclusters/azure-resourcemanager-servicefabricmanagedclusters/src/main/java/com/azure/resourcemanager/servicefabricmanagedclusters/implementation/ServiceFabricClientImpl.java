...
import com.azure.resourcemanager.servicefabricmanagedclusters.fluent.ManagedAzResiliencyStatusClient;
...
import com.azure.resourcemanager.servicefabricmanagedclusters.fluent.ManagedMaintenanceWindowStatusClient;
...
public final class ServiceFabricClientImpl implements ServiceFabricClient {
    ...
    /**
     * The ManagedAzResiliencyStatusClient object to access its operations.
     */
    private final ManagedAzResiliencyStatusClient managedAzResiliencyStatus;

    /**
     * Gets the ManagedAzResiliencyStatusClient object to access its operations.
     * 
     * @return the ManagedAzResiliencyStatusClient object.
     */
    public ManagedAzResiliencyStatusClient getManagedAzResiliencyStatus() {
        return this.managedAzResiliencyStatus;
    }
    ...
    /**
     * The ManagedMaintenanceWindowStatusClient object to access its operations.
     */
    private final ManagedMaintenanceWindowStatusClient managedMaintenanceWindowStatus;

    /**
     * Gets the ManagedMaintenanceWindowStatusClient object to access its operations.
     * 
     * @return the ManagedMaintenanceWindowStatusClient object.
     */
    public ManagedMaintenanceWindowStatusClient getManagedMaintenanceWindowStatus() {
        return this.managedMaintenanceWindowStatus;
    }
    ...
    ServiceFabricClientImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter,
        ...
        this.managedAzResiliencyStatus = new ManagedAzResiliencyStatusClientImpl(this);
        this.managedApplyMaintenanceWindows = new ManagedApplyMaintenanceWindowsClientImpl(this);
        this.managedMaintenanceWindowStatus = new ManagedMaintenanceWindowStatusClientImpl(this);
