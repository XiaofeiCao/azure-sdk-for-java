...
/**
 * An instance of this class provides access to all the operations defined in ManagedAzResiliencyStatusClient.
 */
public final class ManagedAzResiliencyStatusClientImpl implements ManagedAzResiliencyStatusClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final ManagedAzResiliencyStatusService service;
    ...
    /**
     * Initializes an instance of ManagedAzResiliencyStatusClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    ManagedAzResiliencyStatusClientImpl(ServiceFabricClientImpl client) {
        this.service = RestProxy.create(ManagedAzResiliencyStatusService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ServiceFabricClientManagedAzResiliencyStatus to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ServiceFabricClientM")
    public interface ManagedAzResiliencyStatusService {
