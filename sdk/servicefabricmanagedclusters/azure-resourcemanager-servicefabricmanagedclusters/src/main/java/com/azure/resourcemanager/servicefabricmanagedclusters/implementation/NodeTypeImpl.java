...
public final class NodeTypeImpl implements NodeType, NodeType.Definition, NodeType.Update {
    ...
    public FaultSimulation startFaultSimulation(FaultSimulationContent parameters) {
        return serviceManager.nodeTypes()
            .startFaultSimulation(resourceGroupName, clusterName, nodeTypeName, parameters);
    }

    public FaultSimulation startFaultSimulation(FaultSimulationContent parameters, Context context) {
        return serviceManager.nodeTypes()
