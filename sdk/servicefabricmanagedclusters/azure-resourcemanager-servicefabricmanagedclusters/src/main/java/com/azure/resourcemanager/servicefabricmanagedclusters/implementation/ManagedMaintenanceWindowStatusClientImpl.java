...
/**
 * An instance of this class provides access to all the operations defined in ManagedMaintenanceWindowStatusClient.
 */
public final class ManagedMaintenanceWindowStatusClientImpl implements ManagedMaintenanceWindowStatusClient {
    /**
     * The proxy service used to perform REST calls.
     */
    private final ManagedMaintenanceWindowStatusService service;
    ...
    /**
     * Initializes an instance of ManagedMaintenanceWindowStatusClientImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    ManagedMaintenanceWindowStatusClientImpl(ServiceFabricClientImpl client) {
        this.service = RestProxy.create(ManagedMaintenanceWindowStatusService.class, client.getHttpPipeline(),
            client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for ServiceFabricClientManagedMaintenanceWindowStatus to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ServiceFabricClientM")
    public interface ManagedMaintenanceWindowStatusService {
