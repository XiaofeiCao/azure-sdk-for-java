...
public final class DataProductNetworkAcls {
    ...
    /**
     * Get the allowedQueryIpRangeList property: The list of query ips in the format of CIDR allowed to connect to query/visualization endpoint.
     * 
    ...
    /**
     * Set the allowedQueryIpRangeList property: The list of query ips in the format of CIDR allowed to connect to query/visualization endpoint.
     * 
