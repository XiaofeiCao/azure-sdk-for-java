...
public final class DataProductProperties {
    ...
    /**
     * Get the customerManagedKeyEncryptionEnabled property: Flag to enable customer managed key encryption for data product.
     * 
    ...
    /**
     * Set the customerManagedKeyEncryptionEnabled property: Flag to enable customer managed key encryption for data product.
     * 
