...
import com.azure.resourcemanager.networkanalytics.models.PagedOperation;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(NetworkAnalyticsClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for NetworkAnalyticsClientOperations to be used by the proxy service to perform REST calls.
     */
    @Host("{endpoint}")
