...
public final class DataTypesClientImpl implements DataTypesClient {
     ...
     */
    DataTypesClientImpl(NetworkAnalyticsClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for NetworkAnalyticsClientDataTypes to be used by the proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    ...
    public interface DataTypesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> create(@HostParam("endpoint") String endpoint,
            ...
            @HeaderParam("accept") String accept, @BodyParam("application/json") DataTypeInner resource,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataTypeInner>> get(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("dataProductName") String dataProductName, @PathParam("dataTypeName") String dataTypeName,
        ...
        Mono<Response<Flux<ByteBuffer>>> update(@HostParam("endpoint") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("dataProductName") String dataProductName, @PathParam("dataTypeName") String dataTypeName,
            @HeaderParam("accept") String accept, @BodyParam("application/json") DataTypeUpdate properties,
            Context context);
        ...
        @ExpectedResponses({ 202, 204 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> deleteData(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("dataProductName") String dataProductName, @PathParam("dataTypeName") String dataTypeName,
            @HeaderParam("accept") String accept, @BodyParam("application/json") Object body, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ContainerSasTokenInner>> generateStorageContainerSasToken(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("dataProductName") String dataProductName, @PathParam("dataTypeName") String dataTypeName,
            @HeaderParam("accept") String accept, @BodyParam("application/json") ContainerSaS body, Context context);
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DataTypeListResult>> listByDataProduct(@HostParam("endpoint") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String dataProductName,
        ...
        return FluxUtil
            .withContext(context -> service.create(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, dataProductName, dataTypeName, accept, resource,
                context))
    ...
    private Mono<Response<Flux<ByteBuffer>>> createWithResponseAsync(String resourceGroupName, String dataProductName,
        ...
        return service.create(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, dataProductName, dataTypeName, accept, resource, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String dataProductName,
        ...
        return FluxUtil
            .withContext(context -> service.update(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, dataProductName, dataTypeName, accept, properties,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> updateWithResponseAsync(String resourceGroupName, String dataProductName,
        ...
        return service.update(this.client.getEndpoint(), this.client.getApiVersion(), this.client.getSubscriptionId(),
            resourceGroupName, dataProductName, dataTypeName, accept, properties, context);
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteDataWithResponseAsync(String resourceGroupName,
        ...
        return FluxUtil
            .withContext(context -> service.deleteData(this.client.getEndpoint(), this.client.getApiVersion(),
                this.client.getSubscriptionId(), resourceGroupName, dataProductName, dataTypeName, accept, body,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> deleteDataWithResponseAsync(String resourceGroupName,
        ...
        return service.deleteData(this.client.getEndpoint(), this.client.getApiVersion(),
            this.client.getSubscriptionId(), resourceGroupName, dataProductName, dataTypeName, accept, body, context);
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return details of storage container account sas token  along with {@link Response} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ContainerSasTokenInner>> generateStorageContainerSasTokenWithResponseAsync(
        ...
        return FluxUtil
            .withContext(context -> service.generateStorageContainerSasToken(this.client.getEndpoint(),
                ...
                dataTypeName, accept, body, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response of a DataType list operation along with {@link PagedResponse} on successful completion of {@link Mono}.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
