...
public final class DataProductsRemoveUserRoleWithResponseMockTests {
    ...
    public void testRemoveUserRoleWithResponse() throws Exception {
        ...
        manager.dataProducts()
            .removeUserRoleWithResponse("iotwmcdytdxwit", "nrjawgqwg",
                new RoleAssignmentDetailInner().withRoleId("hniskxfbkpyc")
                    .withPrincipalId("klwndnhjdauwhv")
                    .withUsername("l")
                    .withDataTypeScope(Arrays.asList("btdhxujznbm"))
                    .withPrincipalType("ow")
                    .withRole(DataProductUserRole.READER)
                    .withRoleAssignmentId("przqlveu"),
