...
public interface VirtualMachinesClient extends InnerSupportsGet<VirtualMachineInner>,
    ...
    PollerFlux<PollResult<VirtualMachineInner>, VirtualMachineInner> beginCreateOrUpdateAsync(String resourceGroupName,
        String vmName, VirtualMachineInner resource, String ifMatch, String ifNoneMatch);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<VirtualMachineInner> createOrUpdateAsync(String resourceGroupName, String vmName, VirtualMachineInner resource,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<Response<VirtualMachineSizeListResultInner>> listAvailableSizesWithResponseAsync(String resourceGroupName,
        String vmName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<VirtualMachineSizeListResultInner> listAvailableSizesAsync(String resourceGroupName, String vmName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<VirtualMachineSizeListResultInner> listAvailableSizesWithResponse(String resourceGroupName, String vmName,
        Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    VirtualMachineSizeListResultInner listAvailableSizes(String resourceGroupName, String vmName);
}
