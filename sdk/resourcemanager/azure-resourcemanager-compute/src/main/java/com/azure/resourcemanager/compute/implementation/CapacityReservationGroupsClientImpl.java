...
public final class CapacityReservationGroupsClientImpl implements InnerSupportsGet<CapacityReservationGroupInner>,
    ...
    public interface CapacityReservationGroupsService {
        ...
        Mono<Response<CapacityReservationGroupInner>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("capacityReservationGroupName") String capacityReservationGroupName,
            @BodyParam("application/json") CapacityReservationGroupInner resource, @HeaderParam("Accept") String accept,
            Context context);
    ...
    public Mono<Response<CapacityReservationGroupInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String capacityReservationGroupName, CapacityReservationGroupInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, capacityReservationGroupName, resource, accept,
                context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<CapacityReservationGroupInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String capacityReservationGroupName, CapacityReservationGroupInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, capacityReservationGroupName, resource, accept, context);
    }
    ...
    public Mono<CapacityReservationGroupInner> createOrUpdateAsync(String resourceGroupName,
        String capacityReservationGroupName, CapacityReservationGroupInner resource) {
        return createOrUpdateWithResponseAsync(resourceGroupName, capacityReservationGroupName, resource)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<CapacityReservationGroupInner> createOrUpdateWithResponse(String resourceGroupName,
        String capacityReservationGroupName, CapacityReservationGroupInner resource, Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, capacityReservationGroupName, resource, context)
            .block();
    }
    ...
    public CapacityReservationGroupInner createOrUpdate(String resourceGroupName, String capacityReservationGroupName,
        CapacityReservationGroupInner resource) {
        return createOrUpdateWithResponse(resourceGroupName, capacityReservationGroupName, resource, Context.NONE)
            .getValue();
    }
