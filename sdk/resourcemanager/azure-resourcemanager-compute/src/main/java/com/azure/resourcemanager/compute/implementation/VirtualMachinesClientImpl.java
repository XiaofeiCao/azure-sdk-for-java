...
public final class VirtualMachinesClientImpl implements InnerSupportsGet<VirtualMachineInner>,
    ...
    public Mono<Response<VirtualMachineSizeListResultInner>>
        listAvailableSizesWithResponseAsync(String resourceGroupName, String vmName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<Response<VirtualMachineSizeListResultInner>>
        listAvailableSizesWithResponseAsync(String resourceGroupName, String vmName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineSizeListResultInner> listAvailableSizesAsync(String resourceGroupName, String vmName) {
        return listAvailableSizesWithResponseAsync(resourceGroupName, vmName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<VirtualMachineSizeListResultInner> listAvailableSizesWithResponse(String resourceGroupName,
        String vmName, Context context) {
        return listAvailableSizesWithResponseAsync(resourceGroupName, vmName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public VirtualMachineSizeListResultInner listAvailableSizes(String resourceGroupName, String vmName) {
        return listAvailableSizesWithResponse(resourceGroupName, vmName, Context.NONE).getValue();
    }
