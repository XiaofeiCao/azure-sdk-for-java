...
public interface ImagesClient
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<ImageInner> createOrUpdateAsync(String resourceGroupName, String imageName, ImageInner resource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ImageInner createOrUpdate(String resourceGroupName, String imageName, ImageInner resource);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ImageInner createOrUpdate(String resourceGroupName, String imageName, ImageInner resource, Context context);
