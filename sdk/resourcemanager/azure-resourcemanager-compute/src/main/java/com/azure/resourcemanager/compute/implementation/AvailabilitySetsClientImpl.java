...
public final class AvailabilitySetsClientImpl implements InnerSupportsGet<AvailabilitySetInner>,
    ...
    public interface AvailabilitySetsService {
        ...
        @ExpectedResponses({ 200 })
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<VirtualMachineSizeListResultInner>> listAvailableSizes(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("availabilitySetName") String availabilitySetName, @HeaderParam("Accept") String accept,
            Context context);
    ...
    public Mono<Response<AvailabilitySetInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String availabilitySetName, AvailabilitySetInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, availabilitySetName, resource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<AvailabilitySetInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String availabilitySetName, AvailabilitySetInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, availabilitySetName, resource, accept, context);
    }
    ...
    public Mono<AvailabilitySetInner> createOrUpdateAsync(String resourceGroupName, String availabilitySetName,
        ...
        return createOrUpdateWithResponseAsync(resourceGroupName, availabilitySetName, resource)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<AvailabilitySetInner> createOrUpdateWithResponse(String resourceGroupName,
        String availabilitySetName, AvailabilitySetInner resource, Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, availabilitySetName, resource, context).block();
    }
    ...
    public AvailabilitySetInner createOrUpdate(String resourceGroupName, String availabilitySetName,
        AvailabilitySetInner resource) {
        return createOrUpdateWithResponse(resourceGroupName, availabilitySetName, resource, Context.NONE).getValue();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualMachineSizeListResultInner>>
        listAvailableSizesWithResponseAsync(String resourceGroupName, String availabilitySetName) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
    ...
    private Mono<Response<VirtualMachineSizeListResultInner>>
        listAvailableSizesWithResponseAsync(String resourceGroupName, String availabilitySetName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineSizeListResultInner> listAvailableSizesAsync(String resourceGroupName,
        String availabilitySetName) {
        return listAvailableSizesWithResponseAsync(resourceGroupName, availabilitySetName)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<VirtualMachineSizeListResultInner> listAvailableSizesWithResponse(String resourceGroupName,
        String availabilitySetName, Context context) {
        return listAvailableSizesWithResponseAsync(resourceGroupName, availabilitySetName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public VirtualMachineSizeListResultInner listAvailableSizes(String resourceGroupName, String availabilitySetName) {
        return listAvailableSizesWithResponse(resourceGroupName, availabilitySetName, Context.NONE).getValue();
    }
