...
public final class RestorePointCollectionsClientImpl implements InnerSupportsGet<RestorePointCollectionInner>,
    ...
    public interface RestorePointCollectionsService {
        ...
        Mono<Response<RestorePointCollectionInner>> createOrUpdate(@HostParam("$host") String endpoint,
            ...
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("restorePointCollectionName") String restorePointCollectionName,
            @BodyParam("application/json") RestorePointCollectionInner resource, @HeaderParam("Accept") String accept,
            Context context);
    ...
    public Mono<Response<RestorePointCollectionInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String restorePointCollectionName, RestorePointCollectionInner resource) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return FluxUtil.withContext(context -> service.createOrUpdate(this.client.getEndpoint(), apiVersion,
            this.client.getSubscriptionId(), resourceGroupName, restorePointCollectionName, resource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<RestorePointCollectionInner>> createOrUpdateWithResponseAsync(String resourceGroupName,
        String restorePointCollectionName, RestorePointCollectionInner resource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono.error(
                new IllegalArgumentException("Parameter this.client.getEndpoint() is required and cannot be null."));
        }
        ...
        return service.createOrUpdate(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, restorePointCollectionName, resource, accept, context);
    }
    ...
    public Mono<RestorePointCollectionInner> createOrUpdateAsync(String resourceGroupName,
        String restorePointCollectionName, RestorePointCollectionInner resource) {
        return createOrUpdateWithResponseAsync(resourceGroupName, restorePointCollectionName, resource)
            .flatMap(res -> Mono.justOrEmpty(res.getValue()));
    }
    ...
    public Response<RestorePointCollectionInner> createOrUpdateWithResponse(String resourceGroupName,
        String restorePointCollectionName, RestorePointCollectionInner resource, Context context) {
        return createOrUpdateWithResponseAsync(resourceGroupName, restorePointCollectionName, resource, context)
            .block();
    }
    ...
    public RestorePointCollectionInner createOrUpdate(String resourceGroupName, String restorePointCollectionName,
        RestorePointCollectionInner resource) {
        return createOrUpdateWithResponse(resourceGroupName, restorePointCollectionName, resource, Context.NONE)
            .getValue();
    }
