...
public final class ImagesClientImpl
    ...
    public interface ImagesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(@HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion, @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName, @PathParam("imageName") String imageName,
            @BodyParam("application/json") ImageInner resource, @HeaderParam("Accept") String accept, Context context);
    ...
    public Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String imageName,
        ...
        return FluxUtil
            .withContext(context -> service.createOrUpdate(this.client.getEndpoint(), apiVersion,
                this.client.getSubscriptionId(), resourceGroupName, imageName, resource, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(String resourceGroupName, String imageName,
        ...
        return service.createOrUpdate(this.client.getEndpoint(), apiVersion, this.client.getSubscriptionId(),
            resourceGroupName, imageName, resource, accept, context);
    }
    ...
    public PollerFlux<PollResult<ImageInner>, ImageInner> beginCreateOrUpdateAsync(String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, imageName, resource);
    ...
    private PollerFlux<PollResult<ImageInner>, ImageInner> beginCreateOrUpdateAsync(String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> mono
            = createOrUpdateWithResponseAsync(resourceGroupName, imageName, resource, context);
        return this.client.<ImageInner, ImageInner>getLroResult(mono, this.client.getHttpPipeline(), ImageInner.class,
    ...
    public SyncPoller<PollResult<ImageInner>, ImageInner> beginCreateOrUpdate(String resourceGroupName,
        String imageName, ImageInner resource) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, imageName, resource).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ImageInner>, ImageInner> beginCreateOrUpdate(String resourceGroupName,
        String imageName, ImageInner resource, Context context) {
        return this.beginCreateOrUpdateAsync(resourceGroupName, imageName, resource, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ImageInner> createOrUpdateAsync(String resourceGroupName, String imageName, ImageInner resource) {
        return beginCreateOrUpdateAsync(resourceGroupName, imageName, resource).last()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ImageInner> createOrUpdateAsync(String resourceGroupName, String imageName, ImageInner resource,
        Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, imageName, resource, context).last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ImageInner createOrUpdate(String resourceGroupName, String imageName, ImageInner resource) {
        return createOrUpdateAsync(resourceGroupName, imageName, resource).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ImageInner createOrUpdate(String resourceGroupName, String imageName, ImageInner resource, Context context) {
        return createOrUpdateAsync(resourceGroupName, imageName, resource, context).block();
    }
