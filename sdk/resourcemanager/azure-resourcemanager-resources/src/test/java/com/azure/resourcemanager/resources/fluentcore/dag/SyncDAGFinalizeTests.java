...
/**
 * Sync variant of {@link DAGFinalizeTests}.
 */
public class SyncDAGFinalizeTests {
    @Test
    public void testWithoutFinalize() {
        ...
        //
        // Level 0 pizzas
        PizzaImplWrapper pizzaA = new PizzaImplWrapper("A");
        PizzaImplWrapper pizzaI = new PizzaImplWrapper("I");
        // Level 1 pizzas
        PizzaImplWrapper pizzaB = new PizzaImplWrapper("B");
        pizzaB.withInstantPizza(pizzaA);
        PizzaImplWrapper pizzaC = new PizzaImplWrapper("C");
        pizzaC.withInstantPizza(pizzaA);
        PizzaImplWrapper pizzaH = new PizzaImplWrapper("H");
        pizzaH.withInstantPizza(pizzaI);
        // Level 2 pizzas
        PizzaImplWrapper pizzaD = new PizzaImplWrapper("D");
        pizzaD.withInstantPizza(pizzaB);
        PizzaImplWrapper pizzaG = new PizzaImplWrapper("G");
        pizzaG.withInstantPizza(pizzaC);
        // Level 3 pizzas
        PizzaImplWrapper pizzaE = new PizzaImplWrapper("E");
        pizzaE.withInstantPizza(pizzaB);
        pizzaE.withInstantPizza(pizzaG);
        // Level 4 pizzas
        PizzaImplWrapper pizzaF = new PizzaImplWrapper("F");
    ...
    public void testFinalize() {
        ...
        PizzaImplWrapper pizzaJ = new PizzaImplWrapper("J");
        PizzaImplWrapper pizzaM = new PizzaImplWrapper("M");
        PizzaImplWrapper pizzaN = new PizzaImplWrapper("N");
        pizzaJ.withInstantPizza(pizzaM);
        pizzaJ.withInstantPizza(pizzaN);
        PizzaImplWrapper pizzaK = new PizzaImplWrapper("K");
        pizzaA.withDelayedPizza(pizzaJ);
        pizzaA.withDelayedPizza(pizzaK);
        PizzaImplWrapper pizzaL = new PizzaImplWrapper("L");
        PizzaImplWrapper pizzaP = new PizzaImplWrapper("P");
        PizzaImplWrapper pizzaQ = new PizzaImplWrapper("Q");
    ...
    private static class PizzaImplWrapper extends PizzaImpl {
        PizzaImplWrapper(String name) {
            super(name);
        }

        @Override
        public IPizza create() {
            // ensure that PizzaImpl's sync methods are invoked
            return (IPizza) taskGroup().invoke();
        }
    }
}
