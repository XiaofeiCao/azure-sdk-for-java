...
public final class AdminKeysGetSamples {
     ...
     */
    public static void searchGetAdminKeys(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.adminKeys().getWithResponse("rg1", "mysearchservice", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class AdminKeysRegenerateSamples {
     ...
     */
    public static void
        searchRegenerateAdminKey(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.adminKeys()
...
public final class NetworkSecurityPerimeterConfigurationsGetSamples {
     ...
     * @param manager Entry point to SearchServiceManager.
     */
    public static void getAnNSPConfigByName(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
...
public final class NetworkSecurityPerimeterConfigurationsListByServiceSamples {
     ...
     */
    public static void
        listNSPConfigsBySearchService(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.networkSecurityPerimeterConfigurations()
...
public final class NetworkSecurityPerimeterConfigurationsReconcileSamples {
     ...
     * @param manager Entry point to SearchServiceManager.
     */
    public static void reconcileNSPConfig(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.networkSecurityPerimeterConfigurations()
...
public final class OfferingsListSamples {
     ...
     * @param manager Entry point to SearchServiceManager.
     */
    public static void searchListOfferings(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.offerings().listWithResponse(com.azure.core.util.Context.NONE);
    }
}
```
...
public final class OperationsListSamples {
     ...
     * @param manager Entry point to SearchServiceManager.
     */
    public static void searchListOperations(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
...
public final class PrivateEndpointConnectionsDeleteSamples {
     ...
     */
    public static void
        privateEndpointConnectionDelete(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
...
public final class PrivateEndpointConnectionsGetSamples {
     ...
     */
    public static void
        privateEndpointConnectionGet(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.privateEndpointConnections()
...
public final class PrivateEndpointConnectionsListByServiceSamples {
     ...
     * @param manager Entry point to SearchServiceManager.
     */
    public static void listPrivateEndpointConnectionsByService(
        com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.privateEndpointConnections().listByService("rg1", "mysearchservice", com.azure.core.util.Context.NONE);
    }
}
```
...
import com.azure.resourcemanager.search.generated.models.PrivateEndpointConnectionPropertiesPrivateLinkServiceConnectionState;
import com.azure.resourcemanager.search.generated.models.PrivateLinkServiceConnectionStatus;
...
public final class PrivateEndpointConnectionsUpdateSamples {
     ...
     */
    public static void
        privateEndpointConnectionUpdate(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.privateEndpointConnections()
...
public final class PrivateLinkResourcesListSupportedSamples {
     ...
     */
    public static void
        listSupportedPrivateLinkResources(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.privateLinkResources().listSupported("rg1", "mysearchservice", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class QueryKeysCreateSamples {
     ...
     * @param manager Entry point to SearchServiceManager.
     */
    public static void searchCreateQueryKey(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.queryKeys()
...
public final class QueryKeysDeleteSamples {
     ...
     * @param manager Entry point to SearchServiceManager.
     */
    public static void searchDeleteQueryKey(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.queryKeys()
...
public final class QueryKeysListBySearchServiceSamples {
     ...
     */
    public static void
        searchListQueryKeysBySearchService(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.queryKeys().listBySearchService("rg1", "mysearchservice", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServicesDeleteSamples {
     ...
     * @param manager Entry point to SearchServiceManager.
     */
    public static void searchDeleteService(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.services()
            .deleteByResourceGroupWithResponse("rg1", "mysearchservice", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServicesGetByResourceGroupSamples {
     ...
     * @param manager Entry point to SearchServiceManager.
     */
    public static void searchGetService(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.services().getByResourceGroupWithResponse("rg1", "mysearchservice", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServicesListSamples {
     ...
     */
    public static void
        searchListServicesBySubscription(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
...
public final class ServicesListByResourceGroupSamples {
     ...
     */
    public static void
        searchListServicesByResourceGroup(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.services().listByResourceGroup("rg1", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class ServicesUpdateSamples {
     ...
     */
    public static void
        searchUpdateServiceDisableLocalAuth(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
     ...
     */
    public static void
        searchUpdateServiceWithSku(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        SearchService resource = manager.services()
            .getByResourceGroupWithResponse("rg1", "mysearchservice", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update()
     ...
     */
    public static void
        searchUpdateServiceWithCmkEnforcement(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        SearchService resource = manager.services()
            .getByResourceGroupWithResponse("rg1", "mysearchservice", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update()
     ...
     * @param manager Entry point to SearchServiceManager.
     */
    public static void searchUpdateServiceWithDataExfiltration(
        com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        SearchService resource = manager.services()
            .getByResourceGroupWithResponse("rg1", "mysearchservice", com.azure.core.util.Context.NONE)
            .getValue();
     ...
     */
    public static void
        searchUpdateServiceToRemoveIdentity(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        SearchService resource = manager.services()
            .getByResourceGroupWithResponse("rg1", "mysearchservice", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update()
     ...
     */
    public static void
        searchUpdateServiceWithSemanticSearch(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        SearchService resource = manager.services()
            .getByResourceGroupWithResponse("rg1", "mysearchservice", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update()
     ...
     */
    public static void
        searchUpdateServiceAuthOptions(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        SearchService resource = manager.services()
            .getByResourceGroupWithResponse("rg1", "mysearchservice", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update()
     ...
     * @param manager Entry point to SearchServiceManager.
     */
    public static void searchUpdateService(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        SearchService resource = manager.services()
            .getByResourceGroupWithResponse("rg1", "mysearchservice", com.azure.core.util.Context.NONE)
            .getValue();
        resource.update()
     ...
     * @param manager Entry point to SearchServiceManager.
     */
    public static void searchUpdateServiceWithKnowledgeRetrieval(
        com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        SearchService resource = manager.services()
            .getByResourceGroupWithResponse("rg1", "mysearchservice", com.azure.core.util.Context.NONE)
            .getValue();
...
public final class ServicesUpgradeSamples {
     ...
     */
    public static void
        upgradeSearchServiceToLatestVersion(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
...
public final class SharedPrivateLinkResourcesDeleteSamples {
     ...
     */
    public static void
        sharedPrivateLinkResourceDelete(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.sharedPrivateLinkResources()
...
public final class SharedPrivateLinkResourcesGetSamples {
     ...
     */
    public static void
        sharedPrivateLinkResourceGet(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.sharedPrivateLinkResources()
...
public final class SharedPrivateLinkResourcesListByServiceSamples {
     ...
     * @param manager Entry point to SearchServiceManager.
     */
    public static void listSharedPrivateLinkResourcesByService(
        com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.sharedPrivateLinkResources().listByService("rg1", "mysearchservice", com.azure.core.util.Context.NONE);
    }
}
```
...
public final class UsagesListBySubscriptionSamples {
     ...
     * @param manager Entry point to SearchServiceManager.
     */
    public static void getQuotaUsagesList(com.azure.resourcemanager.search.generated.SearchServiceManager manager) {
        manager.usages().listBySubscription("westus", com.azure.core.util.Context.NONE);
    }
}
```
