...
import com.azure.resourcemanager.search.generated.models.UpgradeAvailable;
...
public final class SearchServiceImpl implements SearchService, SearchService.Definition, SearchService.Update {
    ...
    public KnowledgeRetrieval knowledgeRetrieval() {
        return this.innerModel().knowledgeRetrieval();
    }
    ...
    public SearchService create() {
        this.innerObject = serviceManager.serviceClient()
            .getServices()
            .createOrUpdate(resourceGroupName, searchServiceName, this.innerModel(), Context.NONE);
        return this;
    }
    ...
    public SearchService create(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getServices()
            .createOrUpdate(resourceGroupName, searchServiceName, this.innerModel(), context);
        return this;
    }

    SearchServiceImpl(String name, com.azure.resourcemanager.search.generated.SearchServiceManager serviceManager) {
    ...
    public SearchService apply() {
        this.innerObject = serviceManager.serviceClient()
            .getServices()
            .updateWithResponse(resourceGroupName, searchServiceName, updateServiceParam, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public SearchService apply(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getServices()
            .updateWithResponse(resourceGroupName, searchServiceName, updateServiceParam, context)
            .getValue();
        return this;
    }
    ...
    public SearchService refresh() {
        this.innerObject = serviceManager.serviceClient()
            .getServices()
            .getByResourceGroupWithResponse(resourceGroupName, searchServiceName, Context.NONE)
            .getValue();
        return this;
    }
    ...
    public SearchService refresh(Context context) {
        this.innerObject = serviceManager.serviceClient()
            .getServices()
            .getByResourceGroupWithResponse(resourceGroupName, searchServiceName, context)
            .getValue();
        return this;
    }
    ...
    public SearchServiceImpl withKnowledgeRetrieval(KnowledgeRetrieval knowledgeRetrieval) {
        if (isInCreateMode()) {
            this.innerModel().withKnowledgeRetrieval(knowledgeRetrieval);
            return this;
        } else {
            this.updateServiceParam.withKnowledgeRetrieval(knowledgeRetrieval);
            return this;
        }
    }
