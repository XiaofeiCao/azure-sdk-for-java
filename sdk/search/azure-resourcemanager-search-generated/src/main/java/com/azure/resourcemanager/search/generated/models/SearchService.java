...
public interface SearchService {
    ...
    /**
     * Gets the replicaCount property: The number of replicas in the dedicated search service. If specified, it must be
     * a value between 1 and 12 inclusive for standard SKUs or between 1 and 3 inclusive for basic SKU.
     * 
    ...
    /**
     * Gets the partitionCount property: The number of partitions in the dedicated search service; if specified, it can
    ...
    /**
     * Gets the semanticSearch property: Specifies the availability and billing plan for semantic search on the Azure AI
    ...
    /**
     * Gets the knowledgeRetrieval property: Specifies the billing plan for agentic retrieval on the Azure AI Search
    ...
    interface DefinitionStages {
        ...
        interface WithCreate extends DefinitionStages.WithTags, DefinitionStages.WithSku, DefinitionStages.WithIdentity,
            ...
            DefinitionStages.WithSemanticSearch, DefinitionStages.WithKnowledgeRetrieval,
            DefinitionStages.WithUpgradeAvailable {
            /**
        ...
        interface WithReplicaCount {
            /**
             * Specifies the replicaCount property: The number of replicas in the dedicated search service. If
             * specified, it must be a value between 1 and 12 inclusive for standard SKUs or between 1 and 3 inclusive
             * for basic SKU..
             * 
             * @param replicaCount The number of replicas in the dedicated search service. If specified, it must be a
        ...
        interface WithPartitionCount {
            /**
             * Specifies the partitionCount property: The number of partitions in the dedicated search service; if
             * specified, it can be 1, 2, 3, 4, 6, or 12. Values greater than 1 are only valid for standard SKUs. For
             * 'standard3' services with hostingMode set to 'highDensity', the allowed values are between 1 and 3..
             * 
             * @param partitionCount The number of partitions in the dedicated search service; if specified, it can be
             * 1, 2, 3, 4, 6, or 12. Values greater than 1 are only valid for standard SKUs. For 'standard3' services
             * with hostingMode set to 'highDensity', the allowed values are between 1 and 3.
             * @return the next definition stage.
             */
        ...
        interface WithSemanticSearch {
            /**
             * Specifies the semanticSearch property: Specifies the availability and billing plan for semantic search on
             * the Azure AI Search service. This configuration is only available for certain pricing tiers in certain
             * regions..
             * 
             * @param semanticSearch Specifies the availability and billing plan for semantic search on the Azure AI
             * Search service. This configuration is only available for certain pricing tiers in certain regions.
             * @return the next definition stage.
             */
        ...
        /**
         * The stage of the SearchService definition allowing to specify knowledgeRetrieval.
         */
        interface WithKnowledgeRetrieval {
            /**
             * Specifies the knowledgeRetrieval property: Specifies the billing plan for agentic retrieval on the Azure
             * AI Search service. This configuration is only available for certain pricing tiers in certain regions..
             * 
             * @param knowledgeRetrieval Specifies the billing plan for agentic retrieval on the Azure AI Search
             * service. This configuration is only available for certain pricing tiers in certain regions.
             * @return the next definition stage.
             */
            WithCreate withKnowledgeRetrieval(KnowledgeRetrieval knowledgeRetrieval);
        }
    ...
    interface Update extends UpdateStages.WithTags, UpdateStages.WithSku, UpdateStages.WithIdentity,
        ...
        UpdateStages.WithSemanticSearch, UpdateStages.WithKnowledgeRetrieval, UpdateStages.WithUpgradeAvailable {
        /**
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the SearchService update allowing to specify knowledgeRetrieval.
         */
        interface WithKnowledgeRetrieval {
            /**
             * Specifies the knowledgeRetrieval property: Specifies the billing plan for agentic retrieval on the Azure
             ...
             * @return the next definition stage.
             */
            Update withKnowledgeRetrieval(KnowledgeRetrieval knowledgeRetrieval);
        }
