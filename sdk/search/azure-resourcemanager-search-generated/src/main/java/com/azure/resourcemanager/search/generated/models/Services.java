...
public interface Services {
     ...
     */
    Response<Void> deleteByResourceGroupWithResponse(String resourceGroupName, String searchServiceName,
        Context context);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void deleteByResourceGroup(String resourceGroupName, String searchServiceName);
     ...
     * {@link PagedIterable}.
     */
    PagedIterable<SearchService> listByResourceGroup(String resourceGroupName, Context context);
     ...
     * @return a list of all search services in the given subscription as paginated response with {@link PagedIterable}.
     */
    PagedIterable<SearchService> list(Context context);
     ...
     * @return the search service with the given name in the given resource group along with {@link Response}.
     */
    Response<SearchService> getByIdWithResponse(String id, Context context);
