...
import com.azure.resourcemanager.search.generated.implementation.OfferingsImpl;
...
/**
 * Entry point to SearchServiceManager.
 */
public final class SearchServiceManager {
    ...
    private SearchServiceManager(HttpPipeline httpPipeline, AzureProfile profile, Duration defaultPollInterval) {
    ...
    /**
     * Creates an instance of Search Service service API entry point.
     * 
     * @param credential the credential to use.
     * @param profile the Azure profile for client.
     * @return the Search Service service API instance.
     */
    ...
    public static SearchServiceManager authenticate(HttpPipeline httpPipeline, AzureProfile profile) {
        Objects.requireNonNull(httpPipeline, "'httpPipeline' cannot be null.");
        Objects.requireNonNull(profile, "'profile' cannot be null.");
        return new SearchServiceManager(httpPipeline, profile, null);
    }

    /**
     * Gets a Configurable instance that can be used to create SearchServiceManager with optional configuration.
     * 
     * @return the Configurable instance allowing configurations.
     */
    public static Configurable configure() {
        return new SearchServiceManager.Configurable();
    }
    ...
    public static final class Configurable {
        ...
        private static final Map<String, String> PROPERTIES
            = CoreUtils.getProperties("azure-resourcemanager-search-generated.properties");
        ...
        public SearchServiceManager authenticate(TokenCredential credential, AzureProfile profile) {
            ...
            HttpPipeline httpPipeline = new HttpPipelineBuilder().httpClient(httpClient)
                ...
                .build();
            return new SearchServiceManager(httpPipeline, profile, defaultPollInterval);
        }
    }
