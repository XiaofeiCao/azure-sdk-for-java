...
public final class QueryKeysImpl implements QueryKeys {
    ...
    public Response<QueryKey> createWithResponse(String resourceGroupName, String searchServiceName, String name,
        ...
        Response<QueryKeyInner> inner
            = this.serviceClient().createWithResponse(resourceGroupName, searchServiceName, name, context);
    ...
    public PagedIterable<QueryKey> listBySearchService(String resourceGroupName, String searchServiceName,
        Context context) {
        PagedIterable<QueryKeyInner> inner
            = this.serviceClient().listBySearchService(resourceGroupName, searchServiceName, context);
        return ResourceManagerUtils.mapPage(inner, inner1 -> new QueryKeyImpl(inner1, this.manager()));
    }

    public Response<Void> deleteWithResponse(String resourceGroupName, String searchServiceName, String key,
        Context context) {
        return this.serviceClient().deleteWithResponse(resourceGroupName, searchServiceName, key, context);
    }
