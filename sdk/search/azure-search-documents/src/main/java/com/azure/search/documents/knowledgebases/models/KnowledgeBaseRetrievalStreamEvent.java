 ...
 *
 * <p>Use the {@code is*} methods to identify the event payload and the corresponding {@code as*} method to access
 * it. For event names introduced after this SDK version, none of the {@code is*} methods return {@code true}; inspect
...
public final class KnowledgeBaseRetrievalStreamEvent {
    ...
    static KnowledgeBaseRetrievalStreamEvent ofRetrievalStarted(KnowledgeBaseRetrievalStartedEvent value) {
        return new KnowledgeBaseRetrievalStreamEvent(Objects.requireNonNull(value, "'value' cannot be null."), null,
            null, null, null, null, null);
    }

    static KnowledgeBaseRetrievalStreamEvent ofActivityStarted(KnowledgeBaseActivityStartedEvent value) {
        return new KnowledgeBaseRetrievalStreamEvent(null, Objects.requireNonNull(value, "'value' cannot be null."),
            null, null, null, null, null);
    }

    static KnowledgeBaseRetrievalStreamEvent ofActivityCompleted(KnowledgeBaseActivityRecord value) {
    ...
    static KnowledgeBaseRetrievalStreamEvent ofAnswerCompleted(KnowledgeBaseAnswerCompletedEvent value) {
    ...
    static KnowledgeBaseRetrievalStreamEvent ofReferencesCompleted(List<KnowledgeBaseReference> value) {
    ...
    static KnowledgeBaseRetrievalStreamEvent ofError(KnowledgeBaseStreamErrorEvent value) {
    ...
    static KnowledgeBaseRetrievalStreamEvent ofResponseCompleted(KnowledgeBaseResponseCompletedEvent value) {
        return new KnowledgeBaseRetrievalStreamEvent(null, null, null, null, null, null,
            Objects.requireNonNull(value, "'value' cannot be null."));
    }

    static KnowledgeBaseRetrievalStreamEvent ofUnknown() {
