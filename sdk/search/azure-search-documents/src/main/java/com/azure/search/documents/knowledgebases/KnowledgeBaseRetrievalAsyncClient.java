...
public final class KnowledgeBaseRetrievalAsyncClient {
    ...
    /**
     * Retrieves relevant data from backing stores.
     *
     * @param retrievalRequest The retrieval request to process.
     * @param querySourceAuthorization Token identifying the user for which the query is being executed.
     * @return The retrieval response on successful completion.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<KnowledgeBaseRetrievalResult> retrieve(KnowledgeBaseRetrievalOptions retrievalRequest,
    ...
    public Flux<ServerSentEvent<KnowledgeBaseRetrievalStreamEvent>> retrieveStream(
        ...
        return Flux.defer(() -> {
            ...
            return retrieveStreamWithResponse(BinaryData.fromObject(retrievalRequest), requestOptions).flatMapMany(
                response -> ServerSentEventStreams.toFlux(response, KnowledgeBaseRetrievalStreamEvent::fromEvent,
