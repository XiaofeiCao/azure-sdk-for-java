...
public final class KnowledgeBaseRetrievalClient {
     ...
     *
     * If received, the terminal {@code error} or {@code response.completed} event is returned before iteration
     * completes. End-of-stream without a terminal event completes normally. Use the returned stream in a
     * try-with-resources statement to release the response body if iteration completes or stops early. The client does
     ...
     */
    @Generated
    public CloseableIterableStream<ServerSentEvent<KnowledgeBaseRetrievalStreamEvent>> retrieveStream(
