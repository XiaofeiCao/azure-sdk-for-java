...
public final class SearchIndexAsyncClient {
    ...
    PagedFlux<SynonymMap> getSynonymMaps() {
        ...
        RequestOptions requestOptions = new RequestOptions();
        PagedFlux<BinaryData> pagedFluxResponse = this.serviceClient.getSynonymMapsAsync(requestOptions);
    ...
    public PagedFlux<SearchIndexResponse> listIndexesWithSelectedProperties(List<String> select) {
        RequestOptions requestOptions = new RequestOptions();
        if (select != null) {
            requestOptions.addQueryParam("$select", String.join(",", select));
        }
        return this.serviceClient.listIndexesWithSelectedPropertiesAsync(requestOptions)
            .mapPage(item -> item.toObject(SearchIndexResponse.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedFlux<BinaryData> getSynonymMaps(RequestOptions requestOptions) {
        return this.serviceClient.getSynonymMapsAsync(requestOptions);
    }
